...
namespace UrphaCapital.Infrastructure.Migrations
{
    ...
    [Migration("20241117124027_helpChanges")]
    partial class helpChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UrphaCapital.Domain.Entities.Auth.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ozod Ali",
                            PasswordHash = "FJ5hpO8kCykiXVyVXC7F5wdDiu62kLnc2WKPDRz638o=",
                            PhoneNumber = "+998934013443",
                            Role = "SuperAdmin",
                            Salt = "8f28e690-ae6b-4aa3-b6cb-19a52ecb3e68"
                        });
                });
