...
namespace UrphaCapital.Infrastructure.Migrations
{
    ...
    [Migration("20240914181316_thirdMigrationLessonUpdates")]
    partial class thirdMigrationLessonUpdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UrphaCapital.Domain.Entities.Auth.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ozod Ali",
                            PasswordHash = "z7PJWUN+y4J2dW7SdJ82kcVjY3YYG7+8UV1OUkPc+eo=",
                            PhoneNumber = "+998934013443",
                            Role = "SuperAdmin",
                            Salt = "a5cae941-dd44-4b5d-bdc0-9882db8ee01c"
                        });
                });
